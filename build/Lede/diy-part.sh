...
# 后台IP设置
export Ipv4_ipaddr="192.168.50.2"            # 修改openwrt后台地址(填0为关闭)
export Netmask_netm="255.255.255.0"         # IPv4 子网掩码（默认：255.255.255.0）(填0为不作修改)
export Op_name="OpenWrt-Y"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
# 旁路由选项
export Gateway_Settings="192.168.50.1"                 # 旁路由设置 IPv4 网关(填入您的网关IP为启用)(填0为不作修改)
export DNS_Settings="192.168.50.1"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
...
Lede-18.06-5.4.278-ramips-mt7621-xiaomi_mi-router-3g.manifest
Lede-18.06-5.4.278-ramips-mt7621-xiaomi_mi-router-3g-initramfs-kernel.bin
Lede-18.06-5.4.278-ramips-mt7621-xiaomi_mi-router-3g-squashfs-kernel1.bin
Lede-18.06-5.4.278-ramips-mt7621-xiaomi_mi-router-3g-squashfs-rootfs0.bin
EOF
